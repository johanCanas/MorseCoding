package com.mercadoilbre.joescaos.morse.models;
...
public class Morse {
    ...
    public String codeToMorse(String message){
        StringBuilder codificado = new StringBuilder();
        for (int i = 0; i < message.length(); i++) {
            String charComoCadenaYEnMayusculas = String.valueOf(message.charAt(i)).toUpperCase();
            String equivalencia = this.asciiAMorse(charComoCadenaYEnMayusculas);
            codificado
                    .append(equivalencia)
                    .append(" ");
        }
